...
DEGsToDiseases <- function(geneList){
  ...
  petition = paste("?analysis_type=gene&items=",genePeti,"&min_citations_for_gene=5&fdr_cutoff=0.1&output_type=text",sep = "")
  ...
  petition = paste("?analysis_type=geneset&items=",geneSetPeti,"&min_citations_for_gene=5&fdr_cutoff=0.1&output_type=text",sep = "")
