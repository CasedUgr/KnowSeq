...
dataPlot(expressionMatrix,labels,mode = "boxplot", toPNG = T,
toPDF = T)
```
...
dataPlot(t(expressionMatrix),labels,mode = "knnClustering", clusters = 7,toPNG = T,toPDF = T)

expressionMatrixCorrected <- batchEffectRemoval(expressionMatrix, labels, clusters = 7,
method = "combat")
```
