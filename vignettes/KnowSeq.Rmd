...
$$
Where $RED(g,g_i)$ is the redundance between gene $g$ and gen $g_i$ and $DA(g)$ is the DA score of gene $g$. The algorithms ends when a fixed number of genes are selected.
