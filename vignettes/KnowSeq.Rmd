...
results_cv_knn <- knn_trn(DEGsMatrixML,labels,colnames(DEGsMatrixML)[1:10],2)

results_cv_svm <- svm_trn(DEGsMatrixML,labels,rfRanking[1:10],2)

results_cv_rf <- rf_trn(DEGsMatrixML,labels,names(daRanking)[1:10],2)
